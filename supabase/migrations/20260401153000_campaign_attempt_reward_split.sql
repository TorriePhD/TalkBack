create unique index if not exists transactions_campaign_reward_unique_idx
...
where reason = 'campaign_reward'
  and metadata ? 'reward_key';

create or replace function public.award_campaign_attempt_reward(
